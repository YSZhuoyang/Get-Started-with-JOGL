 ...
 * <code>http://www.lighthouse3d.com/cg-topics/code-samples/opengl-3-3-glsl-1-5-sample/</code>
 */
public class Gl3Sample implements GLEventListener {
	...
	int setupShaders(GL3 gl) {
		...
		//vs = textFileRead(vertexFileName);System.out.println(vs);
		fs = textFileRead(fragmentFileName);System.out.println(fs);
	    ...
	    gl.glGetShaderiv(v, GL3.GL_INFO_LOG_LENGTH, intBuffer);
	    ...
	    if (intBuffer.get(0) > 12)
	    {
	        ...
	        if (size > 0)
	        {
	            ...
	            gl.glGetShaderInfoLog(v, size, intBuffer, byteBuffer);
		...
		//printProgramInfoLog(gl, p);
	      ...
	      /*IntBuffer intBuffer = IntBuffer.allocate(1);
	      gl.glGetProgramiv(p, GL3.GL_LINK_STATUS, intBuffer);
	      
	      if (intBuffer.get(0) != 1)
	      {
	          gl.glGetProgramiv(p, GL3.GL_INFO_LOG_LENGTH, intBuffer);
	          int size = intBuffer.get(0);
	          System.err.println("Program link error: ");
	          if (size > 0)
	          {
	              ByteBuffer byteBuffer = ByteBuffer.allocate(size);
	              gl.glGetProgramInfoLog(p, size, intBuffer, byteBuffer);
	              for (byte b : byteBuffer.array())
	              {
	                  System.err.print((char) b);
	              }
