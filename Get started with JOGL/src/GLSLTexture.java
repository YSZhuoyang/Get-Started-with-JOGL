 ...
 * @version 2.28
 */
public class GLSLTexture extends GLCanvas implements GLEventListener 
{
	...
	private FloatBuffer vertBuff = GLBuffers.newDirectFloatBuffer(24);
	...
	public void setupBuffers(GL4 gl)
	{
		...
		gl.glBufferData(GL4.GL_ARRAY_BUFFER, 24 * Float.SIZE / 8, vertBuff, GL4.GL_STATIC_DRAW);
	...
	public static void main(String[] args)
	{
		...
		SwingUtilities.invokeLater(new Runnable()
		{
			public void run()
			{
	            ...
	            GLCanvas canvas = new GLSLTexture();
